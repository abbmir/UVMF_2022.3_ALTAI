...
class BaseElementClass(object):
  def __init__(self,name):
    ...
    self.header = None
    self.interface_location = "env/agents"
    self.environment_location = "env"
    self.vip_location = "."
    self.bench_location = "."
    self.relative_vip_from_sim = ".."+os.path.sep+".."+os.path.sep+".."+os.path.sep+"."
  ...
  def create(self,desired_template='all',parser=None,archive_yaml=True):
    ...
    if (archive_yaml == True):
      ...
      if (self.gen_type == "interface"):
        ...
        ap = dest_dir+"/"+self.bench_location+"/yaml"
      else:
